namespace Lab8_PhilLendingLibrary
{
    internal class Program
    {
        ...
        {
            library.Add("Rich dad and poor dad", "Robert","Kiyosaki", 244);
            library.Add("Atomic Habits", "James", "Clear", 291);
            library.Add("Alaswad yalik biki", "Ahlam", "Mosteghanemi", 331);
            library.Add("The Power Of Your Subconscious Mind", "Joseph", "Murphy", 326);
            library.Add("Ghorbet Alyasmeen", "Khawla", "Hamdy", 409);
        }
