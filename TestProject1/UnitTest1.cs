...
namespace TestProject1
{
    ...
    {
        [Fact]
        public void TestAddBook() //Add a Book to your Library
        {
            // Arrange
        ...
        [Fact]
        public void TestBorrowMissingBook() //Borrowing a missing title returns null
        {
            // Arrange
            var library = new Library();
            library.Add("Title 1", "First Name 1", "Last Name 1", 100);
        ...
        [Fact]
        public void TestBorrowExistingBook() //Borrowing an existing title returns the Book and remove it
        {
            // Arrange
            var library = new Library();
            library.Add("Title 1", "First Name 1", "Last Name 1", 100);
        ...
        [Fact]
        public void TestReturnBook() //A returned book is once again in the Library
        {
            // Arrange
            var library = new Library();
            library.Add("Title 1", "First Name 1", "Last Name 1", 100);
        ...
        [Fact]
        public void TestPackAndUnpack() //Test Pack and Unpack your Backpack
        {
            // Arrange
